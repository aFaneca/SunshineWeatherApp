...
public class Utility {
    ...
    public static String getFriendlyDayString(Context context, long dateInMillis) {
        ...
        if (julianDay == currentJulianDay) {
            String today = context.getString(R.string.weather_display_today);
            int formatId = R.string.weather_display_format_full_friendly_date;
    ...
    public static String getDayName(Context context, long dateInMillis) {
        ...
        if (julianDay == currentJulianDay) {
            return context.getString(R.string.weather_display_today);
        } else if (julianDay == currentJulianDay + 1) {
            return context.getString(R.string.weather_display_tomorrow);
        } else {
            Time time = new Time();
            time.setToNow();
    ...
    static String formatTemperature(double temperature, boolean isMetric) {
        ...
        return String.format("%.0f %s", temp, (isMetric) ? "ºC" : "ºF");
    }
